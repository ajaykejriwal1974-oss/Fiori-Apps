sap.ui.define([
    ...
    // metadata (e.g. "com.sap.gateway.srvd.zui_dispatch_correction.v0001"). Fill the
    ...
    var FILTER_FIELDS = [{ name: "BoxNumber", op: "Contains" }, { name: "SalesOrder", op: "Contains" }, { name: "Status", op: "EQ" }];
    var SEARCH_FIELDS = ["BoxNumber", "SalesOrder"];
    ...
    return Controller.extend("kejriwal.sd.dispatchcorrection.controller.Worklist", {
        ...
        onCorrectDispatch: function () {
            this._runAction("correctDispatch", [{ name: "NewSalesOrder", label: "New Sales Order" }, { name: "NewSalesOrderItem", label: "New Item" }, { name: "NewStatus", label: "New Status" }]);
        },

...
standard SAP (same family as the packing app / `goods-movement-hu-rap.md`):
...
> Sibling of the dyeing-specific [dyeing-packing](../../apps/dyeing-packing) app / `packing-hu-rap.md`.

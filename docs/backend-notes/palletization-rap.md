...
RAP** over standard SAP (same pattern as `goods-movement-hu-rap.md`): a read
...
> Closely related to the [dyeing-packing](../../apps/dyeing-packing) app / `packing-hu-rap.md`; consolidate if you prefer one packing app.

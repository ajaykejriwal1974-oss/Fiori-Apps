...
STEPS = [
 ...
 ("Activate the managed-RAP masters first (lowest effort)",
  ...
  "backend/*-master-rap, docs/backend-notes/gate-pass-rap.md"),
 ...
 ("Register the automation jobs (UPL)",
  ...
  "docs/backend-notes/po-automation.md, docs/backend-notes/obd-automation.md, UPL-MIGRATION.md"),

sap.ui.define([
    ...
    return Controller.extend("kejriwal.mm.huphysinv.controller.Worklist", {
         ...
         * @param {string} sAction  the action name (createPhysInvDoc)
        ...
        _invokeAction: function (sAction, aKeys, oParams) {
            ...
            //   "/HuPhysInv/<ServiceNamespace>.<Action>(...)"

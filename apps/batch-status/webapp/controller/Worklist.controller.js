sap.ui.define([
    ...
    // metadata (e.g. "com.sap.gateway.srvd.zui_batch_status.v0001"). Fill the
    ...
    var SEARCH_FIELDS = ["Material", "Batch"];
    ...
    return Controller.extend("kejriwal.pp.batchstatus.controller.Worklist", {
        ...
        /** F4 value help for the Material filter (bound to /ProductVH = I_ProductStdVH). */
        onMaterialVH: function (oEvt) {

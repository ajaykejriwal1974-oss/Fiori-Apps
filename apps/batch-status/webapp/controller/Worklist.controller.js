sap.ui.define([
    ...
    return Controller.extend("kejriwal.pp.batchstatus.controller.Worklist", {
        ...
        onCloseBatch: function () {
            ...
            var oParams = {};
            this._invokeAction("closeBatch", aKeys, oParams);
        },
        ...
        onDeleteBatch: function () {
            ...
            var oParams = {};
            this._invokeAction("deleteBatch", aKeys, oParams);
        },

        /**
         * Invoke a RAP static action exposed on the OData V4 service.
         * @param {string} sAction  the action name (closeBatch, deleteBatch)

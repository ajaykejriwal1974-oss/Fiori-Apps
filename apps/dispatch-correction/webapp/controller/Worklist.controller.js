sap.ui.define([
    ...
    return Controller.extend("kejriwal.sd.dispatchcorrection.controller.Worklist", {
        ...
        onCorrectDispatch: function () {
            ...
            // Collect header parameter(s): "NewSalesOrder", "NewSalesOrderItem", "NewStatus"
            var oParams = {};
            // TODO: open a sap.m.Dialog to capture "NewSalesOrder", "NewSalesOrderItem", "NewStatus" from the user.
            // oParams.NewSalesOrder = <value from dialog>;
            // oParams.NewSalesOrderItem = <value from dialog>;
            // oParams.NewStatus = <value from dialog>;
            this._invokeAction("correctDispatch", aKeys, oParams);
        },

        /**
         * Invoke a RAP static action exposed on the OData V4 service.
         * @param {string} sAction  the action name (correctDispatch)
        ...
        _invokeAction: function (sAction, aKeys, oParams) {
            ...
            //   "/DispatchBox/<ServiceNamespace>.<Action>(...)"

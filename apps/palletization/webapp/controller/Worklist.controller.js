sap.ui.define([
    ...
    return Controller.extend("kejriwal.pp.palletization.controller.Worklist", {
        ...
        onPackPallet: function () {
            ...
            // Collect header parameter(s): "PackagingMaterial"
            var oParams = {};
            // TODO: open a sap.m.Dialog to capture "PackagingMaterial" from the user.
            // oParams.PackagingMaterial = <value from dialog>;
            this._invokeAction("packPallet", aKeys, oParams);
        },

        /**
         * Invoke a RAP static action exposed on the OData V4 service.
         * @param {string} sAction  the action name (packPallet)
        ...
        _invokeAction: function (sAction, aKeys, oParams) {
            ...
            //   "/Pallet/<ServiceNamespace>.<Action>(...)"

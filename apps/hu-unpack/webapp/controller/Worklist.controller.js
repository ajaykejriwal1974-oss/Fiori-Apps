sap.ui.define([
    ...
    return Controller.extend("kejriwal.mm.huunpack.controller.Worklist", {
        ...
        onUnpackItems: function () {
            ...
            // Collect header parameter(s): "TargetStorageLocation"
            var oParams = {};
            // TODO: open a sap.m.Dialog to capture "TargetStorageLocation" from the user.
            // oParams.TargetStorageLocation = <value from dialog>;
            this._invokeAction("unpackItems", aKeys, oParams);
        },

        /**
         * Invoke a RAP static action exposed on the OData V4 service.
         * @param {string} sAction  the action name (unpackItems)
        ...
        _invokeAction: function (sAction, aKeys, oParams) {
            ...
            //   "/HuUnpack/<ServiceNamespace>.<Action>(...)"

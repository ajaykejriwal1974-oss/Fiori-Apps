sap.ui.define([
    ...
    // metadata (e.g. "com.sap.gateway.srvd.zui_packing_detail.v0001"). Fill the
    ...
    // Project selected rows down to EACH action's _Item contract — packItems takes
    // ZD_PackItem (material content), repackItems takes ZD_RepackItem (HU item + qty).
    // getObject() ships every column + OData annotations otherwise.
    var ITEM_PROJECT = {
        packItems: function (o) { return { Material: o.Material, Batch: o.Batch,
            Quantity: o.Quantity, Unit: o.Unit }; },
        repackItems: function (o) { return { HandlingUnitItem: o.HandlingUnitItem,
            Quantity: o.Quantity }; }
    };
    ...
    var SEARCH_FIELDS = ["Batch", "HandlingUnit", "Material"];
